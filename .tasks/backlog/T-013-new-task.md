...
- [ ] User can open Settings via ⌘, / Ctrl+,
- [ ] User can select from 3 themes: Default (dark), Catppuccin Mocha, Catppuccin Latte
- [ ] Theme selection persists across app restarts (localStorage)
- [ ] All UI components render correctly in all themes (board, sidebar, terminal, file viewer)
- [ ] Code syntax highlighting adapts to selected theme
- [ ] Terminal colors adapt to selected theme
- [ ] Window frame color syncs with theme accent where supported
- [ ] No flash of wrong theme on app startup (blocking script verified)
- [ ] No hardcoded hex colors remain in components (grep verification)
